...
export function HeartModel(props: JSX.IntrinsicElements['group']) {
  ...
  useEffect(() => {
    rightAtrium.current?.skeleton.bones.forEach((bone) => {
      if (bone.name === 'Object_30_0') {
        console.log('found right atrium bone', bone)
        bone.rotation.x = 0.5
      }
    })
    console.log('right atrium', rightAtrium.current)
  }, [rightAtrium.current])
